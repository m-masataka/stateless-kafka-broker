...
impl IndexStore for IndexStoreImpl {
    ...
    async fn get_index_from_start_offset(
        ...
        match self {
            IndexStoreImpl::Redis(r) => {
                r.get_index_from_start_offset(topic, partition, start_offset)
                    .await
            }
            IndexStoreImpl::Tikv(t) => {
                t.get_index_from_start_offset(topic, partition, start_offset)
                    .await
            }
        }
    }
